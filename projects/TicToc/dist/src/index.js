...
var playerMark, comMark, playerScore = 0, comScore = 0, 
// playerChoice,
winner;
// test;
...
function displayttt() {
    for (var i = 0, len = tttArr.length; i < len; i++) {
        if (tttArr[i] == null) {
            ...
            var grid = document.getElementsByClassName("grid")[i];
...
function click(index) {
    if (tttArr[index] == null) {
        var grid = document.getElementsByClassName("grid")[index];
        grid.onclick = function () {
...
var EmployeeCard = /** @class */ (function (_super) {
    ...
    EmployeeCard.prototype.initial = function () {
        ...
        var xPart = document.getElementById("x-part");
        ...
        var oPart = document.getElementById("o-part");
